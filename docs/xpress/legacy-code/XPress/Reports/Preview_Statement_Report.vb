...
Public Class Preview_Statement_Report
    ...
    Private Sub Preview_Statement_Report_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        last_form_close(Me)
    End Sub

    Private Sub Preview_Statement_Report_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Public Sub Preview_Statement_Report_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Me.ReportViewer2.LocalReport.ReportPath = Application.StartupPath & "\Reports\STATEMENT.rdlc" ' Application.StartupPath & "\Reports\INVOICE.rdlc" ' Application.StartupPath & "\Reports\Preview_Medicine.rdlc" ' Application.StartupPath & "\reports\WO_Report.rdlc"
    ...
    Private Sub Preview_Statement_Report_Move(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Move
        Call moved(Me)
    End Sub
