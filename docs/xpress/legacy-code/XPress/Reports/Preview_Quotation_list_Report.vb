...
Public Class preview_quotation_list_report
    ...
    Public Sub load_report()
        ...
        Using cn1 As New SqlConnection(con111)
            cn1.Open()
            Dim q1 As String
            q1 = quotation_query   '"SELECT tbl_quotation_main.*, tbl_customer.* FROM tbl_quotation_main INNER JOIN tbl_customer ON tbl_quotation_main.customer_id = tbl_customer.id where tbl_quotation_main.id='" & quotation_id & "'"
