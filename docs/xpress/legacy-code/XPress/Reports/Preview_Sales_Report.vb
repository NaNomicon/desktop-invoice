...
Public Class Preview_Sales_Report
    ...
    Private Sub Preview_Sales_Report_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        last_form_close(Me)
    End Sub

    Private Sub Preview_Sales_Report_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Public Sub Preview_Sales_Report_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Using cn1 As New SqlConnection(con111)
            cn1.Open()
            Dim q1 As String
            q1 = sales_query   '"SELECT tbl_quotation_main.*, tbl_customer.* FROM tbl_quotation_main INNER JOIN tbl_customer ON tbl_quotation_main.customer_id = tbl_customer.id where tbl_quotation_main.id='" & quotation_id & "'"
        ...
        Me.ReportViewer2.LocalReport.ReportPath = Application.StartupPath & "\Reports\SALES.rdlc" ' Application.StartupPath & "\Reports\INVOICE.rdlc" ' Application.StartupPath & "\Reports\Preview_Medicine.rdlc" ' Application.StartupPath & "\reports\WO_Report.rdlc"
        ...
        End If
        With ReportViewer2
            Dim from1 As New ReportParameter("from_date", Sales_Report.fromdate.Value)
            Dim to1 As New ReportParameter("to_date", Sales_Report.todate.Value)
    ...
    Private Sub Preview_Sales_Report_Move(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Move
        Call moved(Me)
    End Sub
